...
public class LEDController implements OnCheckedChangeListener {
	...
	public LEDController(DemoKitActivity activity, int relayNumber,
			Resources res) {
		mActivity = activity;
		mRelayNumber = relayNumber;
		mCommandTarget = (byte) (relayNumber - 1);
		mOffBackground = res.getDrawable(R.drawable.toggle_button_off_holo_dark);
	...
	public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
		...
		if (mActivity != null) {
			mActivity.sendCommand(DemoKitActivity.LED_COMMAND,
